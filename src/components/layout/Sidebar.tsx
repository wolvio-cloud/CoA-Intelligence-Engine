        ...
        <div className="flex-1 overflow-y-auto px-3 py-4 ">
          <nav className="flex flex-col gap-0.5">
            ...
            {user.role !== "manager" && (
              <>
                <div className="px-3 mb-2 mt-4 first:mt-0">
                  <p className="text-[10px] font-bold uppercase tracking-widest text-slate-400/80">Operations</p>
                </div>
                <Link
                  href="/dashboard"
                  onClick={() => setMobileOpen(false)}
                ...
                >
                  <span className={`shrink-0 ${activePage === "dashboard" ? "text-white" : "text-slate-400"}`}>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <rect x="3" y="3" width="7" height="7" rx="1" />
                      <rect x="14" y="3" width="7" height="7" rx="1" />
                      <rect x="3" y="14" width="7" height="7" rx="1" />
                ...
                >
                  <span className={`shrink-0 ${activePage === "new-coa" ? "text-white" : "text-slate-400"}`}>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                      <polyline points="14 2 14 8 20 8" />
                      <line x1="12" y1="11" x2="12" y2="17" />
                ...
                >
                  <span className={`shrink-0 ${activePage === "recent-coa" ? "text-white" : "text-slate-400"}`}>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <circle cx="12" cy="12" r="10" />
                      <polyline points="12 6 12 12 16 14" />
                    </svg>
            ...
            {user.role === "manager" && (
              <>
                <div className="px-3 mb-2 mt-4 first:mt-0">
                  <p className="text-[10px] font-bold uppercase tracking-widest text-slate-400/80">Oversight</p>
                </div>
                <Link
                  href="/qc-panel"
                  onClick={() => setMobileOpen(false)}
                ...
                >
                  <span className={`shrink-0 ${activePage === "qc-panel" ? "text-white" : "text-slate-400"}`}>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
